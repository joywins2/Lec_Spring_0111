...
public class RestFulClientTest {
	...
	private static final int USER_ID_QUERY = 1; //查询的UserId
	private static final int USER_ID_UPDATE = 18;//更新的UserId
