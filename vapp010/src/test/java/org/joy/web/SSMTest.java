...
import org.joy.service.IUserService;
...
public class SSMTest {
    ...
    public void testUser(){
        ...
        User user = new User("testUser2","999999");
        ...
        userFind.setUserName("yes");
        Boolean updateResult = userService.updateUser(userFind);
        Assert.assertTrue(updateResult);
        Assert.assertEquals("yes",userService.getUserById(userId).getUserName());
